...
class Licensing {
	 ...
	 * @var      string
	 */
	public $store_url = AUTOMATOR_PRO_LICENSING_URL;
	...
	public function __construct() {
		...
		$this->store_url   = AUTOMATOR_PRO_LICENSING_URL;
	...
	public function admin_notices_for_expiry() {
		$license_data = $this->check_license( false );
	}
	...
	public function licensing_call( $endpoint = 'check-license' ) {
		...
		if ( method_exists( '\Uncanny_Automator\Admin_Menu', 'licensing_call' ) ) {
			return \Uncanny_Automator\Admin_Menu::licensing_call( $endpoint, $this->license, AUTOMATOR_PRO_ITEM_ID, AUTOMATOR_PRO_LICENSING_URL );
		}
