...
?>
    ...
    <footer id="colophon" class="site-footer " role="contentinfo">
        <div class="flex max-w-6xl mx-auto items-center justify-between">
            <div class="">
                <a href="https://transparencyreport.google.com/safe-browsing/search?url=https:%2F%2Ffluxomta.com%2F&hl=pt_BR" target="Blank">
                    <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/google-safe-browsing.webp" class="w-48">
                </a>
            </div>
            <div class="">
                <p>Pagamentos 100% seguros e protegidos</p>
